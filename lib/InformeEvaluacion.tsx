  ...
  return (
    <Document title={`Informe evaluación ${d.codigo}`} author={d.organizacion}>
      <Page size="LETTER" style={s.pagina}>
        ...
        {d.archivadas > 0 && (
          <Text style={s.nota}>
            La evaluación fue editada. Este informe muestra los resultados de
            las {d.porPregunta.length} preguntas vigentes; las {d.archivadas} anteriores
            se conservan en el sistema pero no se incluyen porque pertenecen a
            otra versión del cuestionario.
          </Text>
        )}
        <View style={s.thead}>
