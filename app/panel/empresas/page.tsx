...
const s: Record<string, React.CSSProperties> = {
  ...
  tarjeta: { background: 'var(--superficie)', border: '1px solid var(--borde)', borderRadius: 8, overflow: 'hidden', textDecoration: 'none', color: 'inherit', display: 'block' },
  franja: { height: 3 },
  cuerpo: { padding: 18 },
  nombre: { fontSize: 15, margin: '0 0 12px', fontWeight: 600 },
  datos: { margin: 0 },
  fila: { display: 'flex', justifyContent: 'space-between', gap: 10, padding: '5px 0', borderBottom: '1px solid var(--superficie-3)' },
  clave: { fontSize: 11.5, color: 'var(--texto-tenue)', margin: 0 },
  valor: { margin: 0, textAlign: 'right', color: 'var(--texto)' },
