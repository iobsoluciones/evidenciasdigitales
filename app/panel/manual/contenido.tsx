...
export const FASES: { v: Fase; t: string; d: string; color: string }[] = [
  ...
  { v: 'planear', t: 'Planear', d: 'Lo que hay que tener escrito antes de ejecutar nada.', color: 'var(--fase-planear)' },
  { v: 'hacer', t: 'Hacer', d: 'La operación del día a día, que es donde se producen las firmas.', color: 'var(--fase-hacer)' },
  { v: 'verificar', t: 'Verificar', d: 'Mirar lo que se hizo y ponerle nota.', color: 'var(--aviso)' },
  { v: 'actuar', t: 'Actuar', d: 'Lo que se corrige y lo que se rinde.', color: 'var(--fase-actuar)' },
