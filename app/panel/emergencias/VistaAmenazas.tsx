...
const COLORES: Record<Color, { fondo: string; texto: string; letra: string; nombre: string }> = {
  verde: { fondo: 'var(--bien-fondo)', texto: 'var(--bien)', letra: 'B', nombre: 'Baja' },
  amarillo: { fondo: 'var(--ambar-fondo)', texto: 'var(--aviso)', letra: 'M', nombre: 'Media' },
  rojo: { fondo: 'var(--mal-fondo)', texto: 'var(--mal)', letra: 'A', nombre: 'Alta' },
};

const NIVELES: Record<string, { fondo: string; texto: string }> = {
  alto: { fondo: 'var(--mal-fondo)', texto: 'var(--mal)' },
  medio: { fondo: 'var(--ambar-fondo)', texto: 'var(--aviso)' },
  bajo: { fondo: 'var(--bien-fondo)', texto: 'var(--bien)' },
};
...
const s: Record<string, React.CSSProperties> = {
  ...
  labelMini: { display: 'block', fontSize: 11.5, color: 'var(--texto-suave)', marginBottom: 3 },
  input: {
  ...
  ayuda: { fontSize: 11.5, color: 'var(--texto-tenue)', margin: '4px 0 10px', lineHeight: 1.55 },
  ...
  opcion: {
    flex: '1 1 190px', textAlign: 'left', background: 'var(--superficie)',
    border: '1px solid var(--borde)', borderRadius: 8, padding: '9px 12px',
    cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: 2,
  },
  opcionT: { fontSize: 13, color: 'var(--texto)' },
  opcionQue: { fontSize: 11, color: 'var(--texto-tenue)', lineHeight: 1.45 },
  ...
  elementoNombre: { fontSize: 13, fontWeight: 700, color: 'var(--texto)' },
  elementoTotal: {
    fontSize: 11, fontWeight: 700, borderRadius: 20,
    padding: '2px 9px', whiteSpace: 'nowrap',
  },
  elementoAyuda: { fontSize: 11, color: 'var(--texto-tenue)', margin: '0 0 9px', lineHeight: 1.45 },
  ...
  td: { padding: '8px', borderBottom: '1px solid var(--superficie-3)', verticalAlign: 'middle' },
  tdNombre: { padding: '8px 12px', borderBottom: '1px solid var(--superficie-3)', minWidth: 220 },
  nombre: { fontSize: 13, fontWeight: 600, color: 'var(--texto)' },
  meta: { fontSize: 11, color: 'var(--texto-tenue)', marginTop: 2, lineHeight: 1.4 },

  caja: {
    width: 26, height: 26, borderRadius: 6, borderWidth: 1, borderStyle: 'solid',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    fontSize: 12, fontWeight: 700, margin: '0 auto',
  },
  cajaValor: { fontSize: 9.5, color: 'var(--texto-tenue)', marginTop: 2 },

  nivel: {
    fontSize: 10.5, fontWeight: 700, borderRadius: 20,
    padding: '3px 10px', whiteSpace: 'nowrap',
  },
  sinEvaluar: { fontSize: 11, color: 'var(--texto-tenue)', fontStyle: 'italic' },

  leyenda: {
    fontSize: 11.5, color: 'var(--texto-tenue)', lineHeight: 1.6,
